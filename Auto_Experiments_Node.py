    ...
    if Current_exp_name == "iid":
        ...
        for i in range(len(Model_list)):
            ...
            for j in range(len(IID_list)):
                iid = IID_list[j]
                print("--model", f'{model}','--dataset', f'{dataset}',"--is_iid",f'{iid}', "--device_id",f'{device_id}')
                sub.call(["python", filename,"--model", f'{model}','--dataset', f'{dataset}',"--is_iid",f'{iid}', "--device_id",f'{device_id}'])
        ...
        for i in range(len(Model_list)):
            ...
            for j in range(len(num_mali_list)):
                ...
                print("--model", f'{model}', '--dataset', f'{dataset}',"--num_mali",f'{num_mali}', "--device_id",f'{device_id}')
                sub.call(["python", filename,"--model", f'{model}', '--dataset', f'{dataset}',"--num_mali",f'{num_mali}', "--device_id",f'{device_id}'])
        ...
        for i in range(len(Model_list)):
            ...
            for j in range(len(epoch_backdoor_list)):
                ...
                print("--model", f'{model}', '--dataset', f'{dataset}',"--epoch_backdoor",f'{epoch_backdoor}', "--device_id",f'{device_id}')
                sub.call(["python", filename,"--model", f'{model}', '--dataset', f'{dataset}',"--epoch_backdoor",f'{epoch_backdoor}', "--device_id",f'{device_id}'])
        ...
        for i in range(len(Model_list)):
            ...
            for j in range(len(overlapping_rate_list)):
                ...
                print("--model", f'{model}', '--dataset', f'{dataset}',"--overlapping_rate",f'{overlapping_rate}', "--device_id",f'{device_id}')
                sub.call(["python", filename,"--model", f'{model}', '--dataset', f'{dataset}',"--overlapping_rate",f'{overlapping_rate}', "--device_id",f'{device_id}'])
        ...
        for i in range(len(Model_list)):
            ...
            for j in range(len(trigger_size_list)):
                ...
                print("--model", f'{model}', '--dataset', f'{dataset}',"--is_iid",f'{iid}', "--trigger_size",f'{trigger_size}', "--device_id",f'{device_id}')
                sub.call(["python", filename,"--model", f'{model}', '--dataset', f'{dataset}',"--is_iid",f'{iid}', "--trigger_size",f'{trigger_size}', "--device_id",f'{device_id}'])
        ...
        for i in range(len(Model_list)):
            ...
            for j in range(len(trigger_type_list)):
                ...
                print("--model", f'{model}', '--dataset', f'{dataset}',"--is_iid",f'{iid}', "--trigger_type",f'{trigger_type}', "--device_id",f'{device_id}')
                sub.call(["python", filename,"--model", f'{model}', '--dataset', f'{dataset}',"--is_iid",f'{iid}', "--trigger_type",f'{trigger_type}', "--device_id",f'{device_id}'])
        ...
        for i in range(len(Model_list)):
            ...
            for j in range(len(trigger_position_list)):
                ...
                print("--model", f'{model}', '--dataset', f'{dataset}',"--is_iid",f'{iid}', "--trigger_position",f'{trigger_position}', "--device_id",f'{device_id}')
                sub.call(["python", filename,"--model", f'{model}', '--dataset', f'{dataset}',"--is_iid",f'{iid}', "--trigger_position",f'{trigger_position}', "--device_id",f'{device_id}'])
        ...
        for i in range(len(Model_list)):
            ...
            for j in range(len(poisoning_intensity_list)):
                ...
                print("--model", f'{model}', '--dataset', f'{dataset}',"--is_iid",f'{iid}', "--poisoning_intensity",f'{poisoning_intensity}', "--device_id",f'{device_id}')
                sub.call(["python", filename,"--model", f'{model}', '--dataset', f'{dataset}',"--is_iid",f'{iid}', "--poisoning_intensity",f'{poisoning_intensity}', "--device_id",f'{device_id}'])
