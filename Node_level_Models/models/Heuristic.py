...
class Backdoor:
    ...
    def get_trigger_index(self,trigger_size,args):
        ...
        if args.trigger_type == "renyi":
            ...
            G_trigger = nx.watts_strogatz_graph(trigger_size, args.avg_degree, args.density)
        elif args.trigger_type == "ba":
            if args.avg_degree >= trigger_size:
                args.avg_degree = trigger_size - 1
            # n: int Number of nodes
            # m: int Number of edges to attach from a new node to existing nodes
            G_trigger = nx.random_graphs.barabasi_albert_graph(n=trigger_size, m=args.avg_degree)
            ...
            if trigger_size % 2 != 0:
                trigger_size += 1
            G_trigger = nx.random_graphs.random_regular_graph(d=args.avg_degree,
