...
def args_parser():
    ...
    parser.add_argument('--trigger_type', type=str, default="renyi", choices= ["renyi","ws",'ba','rr'],
    ...
    parser.add_argument('--is_iid', type=str, default= "iid", choices=["iid","p-degree-non-iid"],
